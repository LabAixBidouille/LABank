...
import org.fablab.labank.configuration.security.hmac.HmacException;
import org.fablab.labank.configuration.security.hmac.HmacSigner;
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (!request.getRequestURI().contains("/api") || request.getRequestURI().contains("/api/authenticate")){
            ...
            try {
                ...
                //Get user from cache
                //UserDTOOLD userDTO = MockUsers.findByUsername(login);
                ...
                Assert.isTrue(HmacSigner.verifyJWT(jwt, Ehcache.getInstance().getPrivateSecret(Long.valueOf(HmacSigner.getJwtIss(jwt)))),"The Json Web Token is invalid");
